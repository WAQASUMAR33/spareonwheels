  ...
  useEffect(() => {
    const fetchReviews = async () => {
      try {
        ...
        // Calculate the maximum rating from fetched reviews
        const highestRating = fetchedReviews.reduce((max, review) => Math.max(max, review.rating), 0);
  ...
  return (
    <div className="container mx-auto px-4 pt-8">
            ...
            <div className="relative w-full pl-4 ">
              {product.images && product.images.length > 0 ? (
                <motion.img
                  ...
                  alt={product.name}
                  className="md:w-auto w-[400px] mx-auto h-[400px] object-contain mb-4 cursor-pointer"
              ...
              >
                {product.images &&
                  product.images.map((image, index) => (
                    <div className='border-[1px] border-gray-800 rounded-lg overflow-hidden'>
                      <img
                        key={index}
        ...
        <div className="w-full lg:w-2/5 h-full flex flex-col space-y-4 md:space-y-6 mt-4 md:mt-0">
            ...
            <div className="col-span-3">
              <div className="flex flex-col gap-4">
                <div className="flex gap-4">
                  {maxRating>0 && (
                    <>
                      <button className="flex gap-2 justify-center items-center px-3 py-1 bg-yellow-100 rounded-full"
                        onClick={(e) => {
                          e.preventDefault();
                          setActiveTab('reviews');
                          document.getElementById('details-section')?.scrollIntoView({ behavior: 'smooth' }); // Scroll to the section
                        }}
                      >
                        <FaStar /> {maxRating}
                      </button>
                  ...
                  <button
                    className="rounded-full px-2 py-1 bg-black text-white flex gap-1"
                    onClick={(e) => {
                      e.preventDefault(); // Prevent default anchor behavior
                      setActiveTab('reviews'); // Set the active tab
                      document.getElementById('details-section')?.scrollIntoView({ behavior: 'smooth' }); // Scroll to the section
                    }}
                  >
                    Reviews
          ...
          <div className="border rounded-lg p-4 space-y-6">
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                <h3 className="font-bold text-black">Express Delivery</h3>
                <p className="text-sm text-gray-600">
                  <a href="/pages/shippingpolicy" className="text-blue-600 underline">
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">
                  ...
                  <a href="/pages/returnandexchangepolicy" className="text-blue-600 underline">
                    Details
                  </a>
                </p>
              </div>
      ...
      <div className="border rounded-lg p-4">
        ...
        {/* Content Area */}
        <div id='details-section' className="text-gray-700 text-xs md:text-base mt-8 px-4">
          {renderContent()}
        </div>
      </div>
      ...
      >
        <div className="flex flex-col items-center">
          <div className="flex flex-col  justify-center items-center w-full">
            <FaCheckCircle className='text-[#FF0000] text-6xl mb-3' />
