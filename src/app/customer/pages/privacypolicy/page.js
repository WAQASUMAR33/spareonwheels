...
const PrivacyPolicy = () => {
  return (
    <>
      <Head>
        <title>Privacy Policy - Sparesonwheel.com</title>
      </Head>
      <div className="max-w-4xl mx-auto px-6 py-12">
        <h1 className="text-4xl font-bold mb-8 text-center">Privacy Policy</h1>
        {/* <p className="text-sm text-gray-500 mb-4">Last Updated: 2-8-2024</p> */} 
        <p className="mb-4">
          Welcome to Sparesonwheel.com! Your privacy is critically important to us. This privacy policy explains how we collect, use, disclose, and protect your personal information when you visit or make a purchase from <a href="http://www.Sparesonwheel.com" className="text-blue-500 hover:underline">www.Sparesonwheel.com</a>.
        </p>
        ...
        <p className="mb-4">
          For more information about our privacy practices, if you have questions, or if you would like to make a complaint, please contact us by email at <a href="mailto:info@Sparesonwheel.com" className="text-blue-500 hover:underline">info@Sparesonwheel.com</a> or by mail using the details provided below:
        </p>
