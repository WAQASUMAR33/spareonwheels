    ...
    return (
        <div className="w-full flex px-[5px]">
                    ...
                    <ul className="space-y-1">
                        {categories.map((category) => (
                            <li
                                ...
                                className={`flex items-center justify-between p-2 cursor-pointer hover:bg-gray-100  hover:text-gray-900 ${selectedCategory === category.id ? 'bg-[#FF0000] text-white' : ''
                                    }`}
                            >
            ...
            <div className="flex flex-col  md:p-4">
                ...
                <div className="flex gap-2 mb-4 items-center justify-between px-4 md:px-0">
