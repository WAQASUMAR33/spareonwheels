      ...
      <div className="container w-full flex flex-col md:flex-row justify-between items-center px-4">
        <div className="flex flex-col md:flex-row md:space-x-4 text-sm w-full">
          <div className="flex space-x-4 mb-2 md:mb-0">
            <a href="/pages/contactus" className="hover:underline">Contact Us</a>
            <span>/</span>
            <a href="/pages/aboutus" className="hover:underline">About Us</a>
          </div>
          ...
          <div className="flex items-center space-x-2 text-lg">
            {loading ? (
              ...
              <>
                ...
                <a href={socialMediaLinks.pinterest || '#'} target="_blank" rel="noopener noreferrer" className="hover:text-[#FF0000]">
                  <FaPinterest className="text-[#FF0000]" /> {/* Pinterest Red */}
                </a>
              </>
            )}
          </div>
