  ...
  return (
    <div className="container mx-auto p-4 md:p-8">
      ...
      <section className="text-left mb-12">
        ...
        At Spares on Wheels, our mission is to provide top-notch automotive parts and accessories with exceptional customer service. Founded by car enthusiasts, we understand the importance of reliable parts for your car’s performance and your peace of mind. Our team carefully selects each product, ensuring that you have access to only the best in OEM and aftermarket parts. From everyday drivers to passionate car modders, we’re here to support every kind of car owner with quality parts, expert advice, and a passion for the road.
        </p>
