...
const Terms = () => {
  return (
    <>
      <Head>
        <title>Terms and Conditions - Sparesonwheel.com</title>
      </Head>
      <div className="max-w-4xl mx-auto px-6 py-12">
        <h1 className="text-4xl font-bold mb-8 text-center">Terms and Conditions</h1>
        <p className="text-sm text-gray-500 mb-4">Last Updated: [Date]</p>
        <p className="mb-4">
          Welcome to Sparesonwheel.com! These terms and conditions outline the rules and regulations for the use of Sparesonwheel.com's website, located at <a href="http://www.Sparesonwheel.com" className="text-blue-500 hover:underline">www.Sparesonwheel.com</a> (the "Site").
        </p>
        <p className="mb-8">
          By accessing this website, we assume you accept these terms and conditions. Do not continue to use Sparesonwheel.com if you do not agree to take all of the terms and conditions stated on this page.
        </p>

        <h2 className="text-2xl font-semibold mb-4">1. Definitions</h2>
        <p className="mb-8">
          "Company," "We," "Our," "Us": Refers to Sparesonwheel.com.<br />
        ...
        <p className="mb-8">
          All content included on the Site, such as text, graphics, logos, images, and software, is the property of Sparesonwheel.com or its content suppliers and protected by copyright laws.<br />
        ...
        <p className="mb-8">
          To the fullest extent permitted by law, Sparesonwheel.com shall not be liable for any indirect, incidental, special, consequential, or punitive damages, or any loss of profits or revenues, whether incurred directly or indirectly, or any loss of data, use, goodwill, or other intangible losses, resulting from your use of the Site or purchase of products.
        </p>

        <h2 className="text-2xl font-semibold mb-4">9. Indemnification</h2>
        <p className="mb-8">
          You agree to indemnify, defend, and hold harmless Sparesonwheel.com and our affiliates, officers, directors, employees, agents, and suppliers from and against any claims, liabilities, damages, losses, costs, or expenses, including reasonable attorneys' fees, arising out of or in any way connected with your use of the Site or your violation of these terms and conditions.
        </p>
        ...
        <p className="mb-4">
          If you have any questions about these terms and conditions, please contact us at <a href="info@Sparesonwheel.com" className="text-blue-500 hover:underline">info@Sparesonwheel.com</a> or by mail at:
        </p>
