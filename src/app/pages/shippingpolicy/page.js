...
const ShippingPolicy = () => {
  return (
    <>
      <Head>
        <title>Shipping Policy - Sparesonwheel.com</title>
      </Head>
      <div className="max-w-4xl mx-auto px-6 py-12">
        ...
        <p className="mb-4">
          At Sparesonwheel.com, we strive to provide you with the best shopping experience possible. This shipping policy explains the terms under which we ship items purchased from our website, <a href="http://www.Sparesonwheel.com" className="text-blue-500 hover:underline">www.Sparesonwheel.com</a>.
        </p>
        ...
        <p className="mb-8">
          Please ensure that your shipping address is correct. We are not responsible for orders shipped to incorrect addresses provided by the customer. If you realize that you made an error in your shipping address, please contact us as soon as possible at <a href="info@Sparesonwheel.com" className="text-blue-500 hover:underline">info@Sparesonwheel.com</a>.
        </p>

        <h2 className="text-2xl font-semibold mb-4">8. Damages</h2>
        <p className="mb-8">
          Sparesonwheel.com is not liable for any products damaged or lost during shipping. If you received your order damaged, please contact the shipment carrier to file a claim. Please save all packaging materials and damaged goods before filing a claim.
        </p>
