...
export async function POST(request) {
  try {
    ...
    const { deliveryCharge, taxPercentage, other1, other2,smallDeliveryCharge, mediumDeliveryCharge, largeDeliveryCharge,} = data;

    const newSetting = await prisma.settings.create({
      data: {
        smallDeliveryCharge: parseFloat(smallDeliveryCharge),
        mediumDeliveryCharge: parseFloat(mediumDeliveryCharge),
        largeDeliveryCharge: parseFloat(largeDeliveryCharge),
