...
const FilterableTable = () => {
  ...
  const handleAddNewItem = async () => {
    ...
    try {
      const slug = newCategory.slug || newCategory.name.trim().toLowerCase().replace(/\s+/g, '-');
      const categoryToSubmit = { ...newCategory, slug };
      ...
      setNewCategory({ slug: '', name: '', meta_title: '', meta_description: '', meta_keywords: '' });
